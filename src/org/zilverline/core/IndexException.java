...
/**
 * An exception that indicates an Index could not be created.
 * 
...
public class IndexException extends Exception {
     ...
     */
    public IndexException(final String msg) {
        super(msg);
    }
     ...
     */
    public IndexException(final String msg, final Throwable t) {
        super(msg, t);
    }
}
